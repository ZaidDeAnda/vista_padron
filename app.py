...
if check_password():
    ...
    filtered_df = read_data(user, selection="debug")    
    ...
    with st.form("my_form", clear_on_submit=False):
        ...
        submit = st.form_submit_button("Download dataframe", on_click=download_df, kwargs={"user" : user, "selection" : "debug", "df":filtered_df})